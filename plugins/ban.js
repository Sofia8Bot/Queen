...
AMDI({ cmd: "بند", desc: Lang.bandesc, example: Lang.banEx, type: "profile", react: "⛔" }, (async (amdiWA) => {
...
AMDI({ cmd: "فك البان", desc: Lang.unbandesc, example: Lang.unbanEx, type: "profile", react: "✔️" }, (async (amdiWA) => {
...
AMDI({ cmd: "قايمة الباند", desc: Lang.banlistDESC, type: "profile", react: "📓" }, (async (amdiWA) => {
