...
AMDI({ cmd: ["fb", "فيسبوك"], desc: Lang.fbDesc, example: Lang.fbEXA, type: "download", react: "🎥" }, (async (amdiWA) => {
...
AMDI({ cmd: ["انستجرام", "insta", "انستا"], desc: Lang.igDesc, example: Lang.igEXA, type: "download", react: "🌀" }, (async (amdiWA) => {
...
AMDI({ cmd: ["tk", "تيك توك"], desc: Lang.TKDESC, example: Lang.tkEXA, type: "download", react: "🏳️‍🌈" }, (async (amdiWA) => {
...
AMDI({ cmd: ["mediafire", "mf", "ميديا فاير"], desc: Lang.MEDIAFIRE_DESC, type: "download", react: "🔥" }, (async (amdiWA) => {
