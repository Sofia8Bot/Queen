...
AMDI({ cmd: ["ترجم", "translate"], desc: Lang.TRTDESC, example: '.trt en/si', type: "primary", react: "🔠" }, (async (amdiWA) => {
...
AMDI({ cmd: "script", desc: "Queen Amdi deploy site info", react: "💃🏻", type: "primary" }, (async (amdiWA) => {
    ...
    https://chat.whatsapp.com/IZiiX4nKDkZ1SKdtMeZVMF

    🧰 Github:
    https://github.com//Sofia8Bot/Queen

    👨🏻‍💻 Developer:
    https://github.com/Sofia8Bot
