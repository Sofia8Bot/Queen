...
AMDI({ cmd: ["sticker", "s", "ملصق"], desc: Lang.stickerDesc, example: Lang.stickEx, type: "primary", react: "🖼️" }, (async (amdiWA) => {
...
AMDI({ cmd: ["imagestic", "stickerimage", "ملصق صورة", "stic2img"], desc: Lang.imgStic, type: "primary", react: "🔁" }, (async (amdiWA) => {
...
AMDI({ cmd: ["sticvideo", "ملصق فيديو", "s2v"], desc: Lang.VIDSTICDESC, type: "primary", react: "🔁" }, (async (amdiWA) => {
    let { downloadMedia, footerTXT, isTaggedSticker, react, reply, reply_message } = amdiWA.msgLayout;
...
AMDI({ cmd: ["stickerinfo", "معلومات الاستيكر"], desc: Lang.STICINFODESC, type: "primary", react: "ℹ️" }, (async (amdiWA) => {
...
AMDI({ cmd: ["حزمة ملصقات", "bulksticker"], desc: Lang.STICPACKDESC, type: "primary", react: "📁" }, (async (amdiWA) => {
...
AMDI({ cmd: ["emoji", "ايموجي استيكير"], desc: Lang.EMO2STICDESC, type: "primary", react: "🔄️" }, (async (amdiWA) => {
...
AMDI({ cmd: ["صورة ايموجي", "emoimg"], desc: Lang.EMO2PICDESC, type: "primary", react: "🖼️" }, (async (amdiWA) => {
...
AMDI({ cmd: ["emomix", "دمح "], desc: Lang.EMOMIXDESC, example: Lang.EMOMIX_EX, type: "primary", react: "🎨" }, (async (amdiWA) => {
