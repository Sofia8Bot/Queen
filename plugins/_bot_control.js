...
AMDI({ cmd: "اعادة تشغيل", desc: "Restart the bot", type: "profile", react: "🔃" }, (async (amdiWA) => {
...
AMDI({ cmd: "وقف", desc: "Stop the bot", type: "profile", react: "📴" }, (async (amdiWA) => {
...
AMDI({ cmd: "استرجاع", desc: Lang.backupDESC, type: "profile", react: "📤" }, (async (amdiWA) => {
...
AMDI({ cmd: "قيم", desc: Lang.rateDESC, type: "primary", react: "✨" }, (async (amdiWA) => {
...
AMDI({ cmd: "تنظيف", desc: Lang.clearDESC, type: "profile", react: "🚮" }, (async (amdiWA) => {
...
AMDI({ cmd: "نظف", desc: "Reset process control limits", type: "profile", react: "♻️" }, (async (amdiWA) => {
