...
AMDI({ cmd: "مجموعه", desc: Lang.grpDESC, type: "admin", react: "🕹️" }, (async (amdiWA) => {
...
AMDI({ cmd: "ضيف", desc: Lang.addDESC, example: Lang.addEX, type: "admin", react: "➕" }, (async (amdiWA) => {
...
AMDI({ cmd: "اطرد", desc: Lang.kickDESC, example: Lang.kickEXA, type: "admin", react: "🚫" }, (async (amdiWA) => {
...
AMDI({ cmd: "رقي", desc: Lang.PROMOTE_DESC, example: Lang.PromoEX, type: "admin", react: "🔝" }, (async (amdiWA) => {
...
AMDI({ cmd: "خفض", desc: Lang.DEMOTE_DESC, example: Lang.DemoEX, type: "admin", react: "🔙" }, (async (amdiWA) => {
...
AMDI({ cmd: "كتم", desc: Lang.MUTE_DESC, type: "admin", react: "🔇" }, (async (amdiWA) => {
...
AMDI({ cmd: "الغاء الكتم", desc: Lang.UNMUTE_DESC, type: "admin", react: "🔊" }, (async (amdiWA) => {
    let { reply } = amdiWA.msgLayout
...
AMDI({ cmd: "اقفل", desc: Lang.LOCKGRP_DESC, type: "admin", react: "🔒" }, (async (amdiWA) => {
    let { reply } = amdiWA.msgLayout
...
AMDI({ cmd: "الغاء القفل", desc: Lang.UNLOCKGRP_DESC, type: "admin", react: "🔒" }, (async (amdiWA) => {
    let { reply } = amdiWA.msgLayout
...
AMDI({ cmd: "دعوة", desc: Lang.inviteDESC, type: "admin", react: "🫱🏻‍🫲🏻" }, (async (amdiWA) => {
...
AMDI({ cmd: "سحب", desc: Lang.revokeDESC, type: "admin", react: "🔁" }, (async (amdiWA) => {
...
AMDI({ cmd: "موضوع", desc: Lang.SUBJECTDESC, example: Lang.subEX, type: "admin", react: "✏️" }, (async (amdiWA) => {
...
AMDI({ cmd: "مضاد الروابط", desc: Lang.ANTILINK_DESC, type: "admin", react: "⛔" }, (async (amdiWA) => {
